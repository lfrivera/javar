...
3.  **Create a symbolic link Rserve in R bin folder:** type the following command on terminal: "ln -s CURRENT_RSERVE_LIBRARY_LOCATION /usr/lib/R/bin/Rserve" (e.g., ln -s /home/lfrivera/R/x86_64-pc-linux-gnu-library/3.2/Rserve/libs/Rserve /usr/lib/R/bin/Rserve).
